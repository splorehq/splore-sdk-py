...
class MarkdownConverter:
    ...
    def convert(
        ...
        Args:
            ...
            extensions: List of extensions to use. Default includes 'extra', 'tables', and 'codehilite'.
        ...
        self.logger.debug(f"Converting Markdown to HTML with extensions: {md_extensions}")
